import {ContaInexistenteError, SaldoInsuficienteError, AplicacaoError, ValorInvalidoError, PoupancaInvalidaError} from "./01.js"
...
export class Banco {
    ...
    consultarPoupanca(Tpoupanca: Poupanca): string {
        ...
        throw new PoupancaInvalidaError("Poupança não encontrada")
    }
